          ...
          <div key={item.name} className={styles.pItem}>
            ...
            <div className={styles.pItemContent}>
              {item.children.map((i, index) => (
                <div
                  key={index}
                  className={styles.pItemMain}
                  onClick={() => {
                    props.handleClickMain(i.name);
                  }}
                >
                  ...
                  <div className={styles.itemContent}>
                    <div>
                      ...
                      <span className={styles.pltype}>{i.payType}</span>
                    </div>
                    <div>
                      <span className={styles.plnum}>{i.time}</span>
                      <span className={`${styles.pltype} ${styles.abnormal}`}>{i.status}</span>
                    </div>
                  </div>
                </div>
              ))}
